			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == ArcanumOfWisdomModItems.COMBINED_ARTIFACT.get()) {
				if (entity.getData(ArcanumOfWisdomModVariables.PLAYER_VARIABLES).arcana_active == true) {
					if ((entity.level().dimension()) == Level.OVERWORLD) {
						if (entity instanceof LivingEntity _livEnt6 && _livEnt6.hasEffect(ArcanumOfWisdomModMobEffects.ARCANA_WISDOM.get())) {
						...
						} else if (entity instanceof LivingEntity _livEnt10 && _livEnt10.hasEffect(ArcanumOfWisdomModMobEffects.ARCANA_WISDOM_COOLDOWN.get())) {
