...
public class ArtifactOfMagicRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (entity instanceof LivingEntity _livEnt7 && _livEnt7.hasEffect(MobEffects.LUCK)) {
		...
		if (entity instanceof LivingEntity _livEnt12 && _livEnt12.hasEffect(MobEffects.HERO_OF_THE_VILLAGE)) {
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
