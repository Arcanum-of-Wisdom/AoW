...
public class LVL100Procedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof Player _plr ? _plr.experienceLevel : 0) == 100 && entity.getData(ArcanumOfWisdomModVariables.PLAYER_VARIABLES).wisdom < 100) {
			{
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.CLOUD, x, y, z, 20, 0, 0.5, 0, 0.5);
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.COMPOSTER, x, y, z, 30, 0, 0, 0, 0.5);
			if (world instanceof ServerLevel _level)
