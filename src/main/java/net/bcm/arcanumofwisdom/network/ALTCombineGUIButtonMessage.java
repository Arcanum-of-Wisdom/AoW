...
public record ALTCombineGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(ArcanumOfWisdomMod.MODID, "alt_combine_gui_buttons");
	public ALTCombineGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public static void handleData(final ALTCombineGUIButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		ArcanumOfWisdomMod.addNetworkMessage(ALTCombineGUIButtonMessage.ID, ALTCombineGUIButtonMessage::new, ALTCombineGUIButtonMessage::handleData);
	}
}
