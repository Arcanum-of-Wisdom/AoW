...
public class ArtifactOfFluidsItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.arcanum_of_wisdom.artifact_of_fluids.description_0"));
		list.add(Component.translatable("item.arcanum_of_wisdom.artifact_of_fluids.description_1"));
	}
