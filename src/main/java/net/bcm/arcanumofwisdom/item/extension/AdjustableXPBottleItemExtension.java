...
public class AdjustableXPBottleItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(ArcanumOfWisdomModItems.ADJUSTABLE_BOTTLE_OF_ENCHANTING.get(), new OptionalDispenseItemBehavior() {
