...
public class ArtifactlaboratorytableguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ArtifactlaboratorytableguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ArcanumOfWisdomModMenus.ARTIFACTLABORATORYTABLEGUI.get(), id);
